...
CREATE DATABASE K_UNIVER
 CONTAINMENT = NONE
 ON PRIMARY
( NAME = N'K_UNIVER_mdf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER.mdf' , SIZE = 8192KB , MAXSIZE = 10240KB , FILEGROWTH = 1024KB ),
( NAME = N'K_UNIVER_ndf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER.ndf' , SIZE = 5120KB , MAXSIZE = 10240KB , FILEGROWTH = 10%), 
 FILEGROUP [G1] 
( NAME = N'K_UNIVER11_ndf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER11.ndf' , SIZE = 10240KB , MAXSIZE = 15360KB , FILEGROWTH = 1024KB ),
( NAME = N'K_UNIVER12_ndf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER12.ndf' , SIZE = 2048KB , MAXSIZE = 5120KB , FILEGROWTH = 1024KB ), 
 FILEGROUP [G2]
( NAME = N'K_UNIVER21_ndf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER21.ndf' , SIZE = 5120KB , MAXSIZE = 10240KB , FILEGROWTH = 1024KB ),
( NAME = N'K_UNIVER22_ndf', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER22.ndf' , SIZE = 2048KB , MAXSIZE = 5120KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'K_UNIVER_log', FILENAME = N'D:\_Универ\2 Курс\4 семестр\БД\UNIVER\K_UNIVER.ldf' , SIZE = 5120KB , MAXSIZE = 2048GB , FILEGROWTH = 1024KB )
GO
USE K_UNIVER
drop table progress
drop table student
